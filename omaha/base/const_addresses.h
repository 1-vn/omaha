...
const TCHAR* const kUrlUpdateCheck =
    _T("https://updates.onevnsoftware.com/service/update2");
...
const TCHAR* const kUrlCrashReport =
    _T("https://updates.onevnsoftware.com/cr/report");

// More information url.
// Must allow query parameters to be appended to it.
const TCHAR* const kUrlMoreInfo =
    _T("https://updates.onevnsoftware.com/support/installer/?");

// Code Red check url.
const TCHAR* const kUrlCodeRedCheck =
    _T("https://updates.onevnsoftware.com/service/check2");

// Usage stats url.
const TCHAR* const kUrlUsageStatsReport =
    _T("https://updates.onevnsoftware.com/tbproxy/usagestats");
