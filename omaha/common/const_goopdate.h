...
const TCHAR* const kRegValueServiceName           = _T("onevn_service_name");
const TCHAR* const kRegValueMediumServiceName     = _T("onevnm_service_name");
const TCHAR* const kRegValueTaskNameC             = _T("onevn_task_name_c");
const TCHAR* const kRegValueTaskNameUA            = _T("onevn_task_name_ua");
...
const TCHAR* const kServicePrefix               = _T("onevn");
const TCHAR* const kMediumServicePrefix         = _T("onevnm");
